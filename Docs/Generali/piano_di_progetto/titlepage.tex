...
\begin{titlepage}
	...
	\begin{tabular}{r|l}
		...
		\textbf{Uso} & esterno\\                         
		\textbf{Approvazione} & -\\                      
		\textbf{Redazione} & \parbox[t]{5cm}{ Bergamin Elia \\ Chilese Elena \\ Djossa Edgar \\ Pincin Matteo} \\
		\textbf{Verifica} &  \parbox[t]{5cm}{Diviesti Filippo \\ Bergamin Elia \\ Soranzo Andrea \\ Chilese Elena}\\                         
