...
\requirementsTable{
    ...
    %ZOOM
    \RFM & L’utente deve poter eseguire un’azione di zoom indipendentemente dalla posizione della telecamera & Obbligatorio & UC12\par UC12.1\par UC12.2\tabularnewline
...
\requirementsTable{
    ...
    \RQM & La consegna del progetto deve includere i diagrammi UML relativi ai casi d'uso identificati & Obbligatorio & Decisione interna \tabularnewline
    \RQM & Il software deve essere testato attraverso test di tipo e2e, concentrando l'attenzione sulle funzionalità chiave che impattano negativamente sull'esperienza utente (non più di 10 funzionalità)  & Desiderabile  & Capitolato \tabularnewline 
    \RQM & Deve essere consegnata la documentazione relativa ai test effettuati con i relativi risultati & Obbligatorio & Decisione interna \tabularnewline
}
 \pagebreak
...
\requirementsTable{
    ...
    \RVM & Il software deve supportare un massimo di 500 elementi per le coordinate X e Z mantenendo il limite di 1000 dati (es. con 500 righe, il massimo numero di colonne sarà pari a 5) & Obbligatorio & Decisione interna \tabularnewline
    ...
    \RVM & Il backend del software deve essere sviluppato utilizzando Node.js & Obbligatorio & Decisione interna \tabularnewline
    \RVM & Il framework Express.js deve essere utilizzato per la gestione delle API & Obbligatorio & Decisione interna \tabularnewline
    \RVM & Il sistema di caching deve essere eseguito in un container Docker per garantire isolamento e facilità di gestione & Obbligatorio & Decisione interna \tabularnewline
    }
\newpage
...
\SrcToReqTable{
    ...
    UC12.1    & RF19 \tabularnewline
    UC12.2    & RF19 \tabularnewline
...
\ReqToUCTable{
    ...
    RF19 & UC12\par UC12.1\par UC12.2 \tabularnewline
    ...
    RQ3 & Decisione interna\tabularnewline
    RQ4 & Capitolato\tabularnewline
    RQ5 & Decisione interna\tabularnewline
...
\requirementsSummaryTable{
    ...
    \bottomrule
    \textbf{Totale requisiti} & \arabic{M} & \arabic{D} & \arabic{O} & \arabic{T} \tabularnewline
